    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-200 py-12">
      <div className="card w-full md:w-3/4 lg:w-2/3 xl:w-1/2 bg-base-100 shadow-xl rounded-lg border border-gray-300 transition-transform transform hover:scale-105 hover:shadow-2xl duration-300 ease-in-out">
        <div className="card-body p-8">
          <h2 className="card-title text-4xl lg:text-5xl font-bold text-center mb-6 text-white-800 transition-colors duration-300 ease-in-out hover:text-blue-600">
            About Us
          </h2>
          <p className="text-lg leading-relaxed text-white-700 mb-4 transition-colors duration-300 ease-in-out hover:text-blue-600">
